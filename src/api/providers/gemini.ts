...
//
// <plan> (the pre-prose "twist"/"distinct" scratchpad, xmlTurnContract.ts)
// gets the same treatment: it's a one-turn reasoning aid for the turn that
// already produced it, worthless as replayed context and pure token cost
// if resent on every later call.
