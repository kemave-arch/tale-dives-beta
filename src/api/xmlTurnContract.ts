...
<sync>
  ...
  <npc id="NPC_ID" aff="+|-" trust="+|-" resolve="Untrained|Novice|Adept|Expert|Master" deed="DEED_TEXT" mem="MEM_SUMMARY" wld="HELD_WEAPON" armor="WORN_ARMOR" personality="PERSONALITY_SUMMARY" faction="FACTION_ID" secret="HIDDEN_TRUTH" />
