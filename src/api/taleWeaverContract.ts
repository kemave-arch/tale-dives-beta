...
<phase>
  ...
  <protagonist name="NAME" background="BACKGROUND" personality="PERSONALITY" motivation="MOTIVATION" physical_trait="PHYSICAL_TRAIT" secret="SECRET" opening="OPENING_SCENE" class="CLASS_OR_ARCHETYPE" />
...
- Protagonist phase: exactly one <protagonist> tag with every attribute populated, including a fitting "class" (a short evocative class/archetype name — e.g. "Warrior", "Mage", "Dragon Rider", "Necromancer", "Scribe" — or an original one fitting the world's own power system; never leave it blank). Also include 0-3 <skill> tags for starting abilities that genuinely make sense given the protagonist's background and class — omit entirely for a mundane, non-abilities-based character concept rather than inventing one that doesn't fit.
