...
<sync>
  <turn state="TURN_STATE" d="DAY_INT" h="TIME_STR" loc="LOC_ID" locdisp="LOC_DISPLAY_NAME" desc="LOC_DESC" mood="MOOD_TAG" c="±N" area="AREA_ID_or_none" areadisp="AREA_NAME" areadesc="AREA_DESC" region="REGION_ID" regiondisp="REGION_NAME" mapx="N" mapy="N" />
