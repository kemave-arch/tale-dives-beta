...
- <item>, <corpse>, <flag>, <npc>, <fac>, <skill>, <enrich>, <project>, <event> may each repeat 0 or more times — one tag per item/enemy/flag/NPC/faction/skill/entity/project/event affected this turn.
